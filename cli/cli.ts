...
import { cleanBackupCertificates } from './commands/clean-backup-certificates.ts'
import type { CommandDefinition } from './commands/CommandDefinition.ts'
import { configureFeedbackCommand } from './commands/configure-feedback.ts'
import { configureMapCommand } from './commands/configure-map.ts'
import { configureMemfaultCommand } from './commands/configure-memfault.ts'
import { configureRFCloudAccountCommand } from './commands/configure-nrfcloud-account.ts'
import { createFakeNrfCloudAccountDeviceCredentials } from './commands/create-fake-nrfcloud-account-device-credentials.ts'
import { createFakeNrfCloudHealthCheckDevice } from './commands/create-fake-nrfcloud-health-check-device.ts'
import { createHealthCheckDevice } from './commands/create-health-check-device.ts'
import { getNRFCloudBulkOpsStatus } from './commands/get-nrfcloud-bulkops-status.ts'
import { importDeviceCommand } from './commands/import-device.ts'
import { importDevicesCommand } from './commands/import-devices.ts'
import { importUnsupportedDevice } from './commands/import-unsupported-device.ts'
import { initializeNRFCloudAccountCommand } from './commands/initialize-nrfcloud-account.ts'
import { listDevicesCommand } from './commands/list-devices.ts'
import { listnRFCloudAccountsCommand } from './commands/list-nrfcloud-accounts.ts'
import { logsCommand } from './commands/logs.ts'
import { registerDeviceCommand } from './commands/register-device.ts'
import { showDeviceCommand } from './commands/show-device.ts'
import { showFingerprintCommand } from './commands/show-fingerprint.ts'
import { showNRFCloudAccount } from './commands/show-nrfcloud-account.ts'
import { updateLambda } from './commands/update-lambda.ts'
